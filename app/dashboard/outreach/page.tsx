                  ...
                  <tbody className="divide-y divide-gray-100/50">
                    {outreach.map((o, idx) => {
                      ...
                      return (
                        <tr
                          key={o.id}
                          className="hover:bg-rose-50/30 transition-colors animate-fadeIn"
                          style={{ animationDelay: `${idx * 50}ms` }}
                        >
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-3">
                              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-rose-100 to-pink-100 flex items-center justify-center flex-shrink-0 text-rose-600">
                          ...
                          <td className="px-6 py-4">
                            <span className={`inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-medium border ${colorClasses[status.color]}`}>
                              {status.label}
                            </span>
                          </td>
                          <td className="px-6 py-4">
