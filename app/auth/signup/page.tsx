      ...
      <main className="relative min-h-screen overflow-hidden bg-gradient-to-br from-rose-50 via-white to-purple-50">
        ...
        <div className="relative flex min-h-screen flex-col items-center justify-center px-6">
          <div className="w-full max-w-md text-center animate-fadeIn">
            <div className="mb-8">
              <div className="mx-auto w-20 h-20 bg-gradient-to-br from-rose-400 to-purple-400 rounded-full flex items-center justify-center mb-6 animate-fadeIn" style={{ animationDelay: '100ms' }}>
                <svg className="w-10 h-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 19v-8.93a2 2 0 01.89-1.664l7-4.666a2 2 0 012.22 0l7 4.666A2 2 0 0121 10.07V19M3 19a2 2 0 002 2h14a2 2 0 002-2M3 19l6.75-4.5M21 19l-6.75-4.5M3 10l6.75 4.5M21 10l-6.75 4.5m0 0l-1.14.76a2 2 0 01-2.22 0l-1.14-.76" />
                </svg>
              </div>

              <h1 className="text-4xl font-serif font-light tracking-tight mb-4 animate-fadeIn" style={{ animationDelay: '200ms' }}>
    ...
    <main className="relative min-h-screen overflow-hidden bg-gradient-to-br from-rose-50 via-white to-purple-50">
      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center px-6 py-12">
        ...
        <div className="w-full max-w-md animate-fadeIn">
          ...
          >
            ...
            <div className="relative">
              ...
              <button
                ...
                disabled={loading}
                className="w-full px-6 py-3 mb-6 bg-white backdrop-blur-sm border border-gray-200/50 rounded-xl hover:bg-white hover:shadow-lg hover:scale-[1.02] transition-all duration-300 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed group"
              >
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white/80 text-gray-500 font-light">or create with email</span>
                </div>
              </div>
              ...
              {/* Terms */}
              <p className="mt-6 text-center text-xs text-gray-500 font-light leading-relaxed">
          ...
          {/* Footer decoration */}
          <div className="mt-8 flex items-center justify-center gap-2 text-xs text-gray-400 font-light animate-fadeIn" style={{ animationDelay: '300ms' }}>
