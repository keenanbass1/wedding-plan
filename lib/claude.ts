...
// Initialize Claude API client (shared singleton)
...
export async function* streamChatResponse(
  ...
  const {
    systemPrompt = 'You are a helpful Bower assistant.',
    maxTokens = 1024,
    temperature = 0.7,
  } = options
...
// Bower specific system prompt
export const WEDDING_PLANNER_PROMPT = `
You are a friendly, empathetic Bower assistant helping couples plan their dream wedding in New South Wales, Australia.
